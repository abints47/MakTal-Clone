              ...
              {navLinks.map((link) =>
                link.hasDropdown ? (
                  ...
                  >
                    ...
                    >
                      <div className={`rounded-2xl bg-[#13101f] border border-white/8 shadow-2xl shadow-black/60 p-7 sm:p-8 origin-top transition-transform duration-300 ease-out ${servicesOpen ? 'translate-y-0 scale-100' : '-translate-y-2 scale-[0.98]'}`}>
                              ...
                              <ul className="flex flex-col gap-2.5">
                                {category.items.map((item) => (
                                  <li key={item}>
                                    <a
                                      href="#services"
                                      className="text-white/55 hover:text-white text-[13.5px] leading-snug transition-colors duration-200"
                                    >
                                      {item}
                                    </a>
                                  </li>
