      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <ScrollReveal key={index} delay={index * 100}>
              <a href={post.url} className="group block project-card">
                <div className="relative w-full aspect-[1.6/1] overflow-hidden">
                  ...
                  <span className="absolute top-4 left-4 font-mono text-[10px] uppercase tracking-[0.2em] text-[#00D4FF] bg-[#00D4FF]/10 border border-[#00D4FF]/20 px-2.5 py-1 rounded-md backdrop-blur-sm">{post.tag}</span>
                </div>
                <div className="p-5 sm:p-6">
                  <h3 className="text-white text-base sm:text-lg font-semibold leading-[1.4] transition-colors duration-300 group-hover:text-[#00D4FF]">
                    {post.title}
                  </h3>
        ...
        <ScrollReveal delay={200}>
          <div className="flex justify-center mt-10 sm:mt-14">
            <a href="#blog" className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-white/10 bg-transparent text-white/50 text-sm font-medium tracking-wide transition-all duration-300 hover:border-[#00D4FF]/30 hover:text-[#00D4FF] hover:bg-[#00D4FF]/5">
              View All Posts
            </a>
          </div>
        </ScrollReveal>
