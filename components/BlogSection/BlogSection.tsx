      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        <ScrollReveal>
          <div className="text-center mb-14 sm:mb-20">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-black/[0.06] bg-[#0077B6]/5 text-[#0077B6] text-xs font-medium tracking-widest uppercase mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {blogPosts.map((post, index) => (
            <ScrollReveal key={index} delay={index * 100}>
              <a href={post.url} className="group block bg-white rounded-2xl overflow-hidden border border-black/[0.06] shadow-sm hover:shadow-xl hover:shadow-[#00AEEF]/5 transition-all duration-500 hover:border-[#00AEEF]/20 hover:-translate-y-1">
                <div className="relative w-full aspect-[1.6/1] overflow-hidden">
                  ...
                  <span className="absolute top-4 left-4 px-3 py-1 rounded-full bg-white/90 backdrop-blur-md text-[#0077B6] text-[10px] font-semibold tracking-wide uppercase border border-black/[0.06]">
                    {post.tag}
                  </span>
                </div>
        ...
        <ScrollReveal delay={200}>
          <div className="flex justify-center mt-10 sm:mt-14">
            <a
              href="#blog"
              className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-black/[0.1] bg-transparent text-black/60 text-sm font-medium tracking-wide transition-all duration-300 hover:border-[#00AEEF]/40 hover:text-[#00AEEF] hover:bg-[#00AEEF]/5"
            >
              View All Posts
            </a>
          </div>
