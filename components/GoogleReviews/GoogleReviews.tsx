...
const reviews = [
  {
    ...
    date: "7 months ago",
    rating: 5,
    text: "Highly reliable SEO & digital marketing company for Thrissur and Kerala businesses. MakTal Technologies offers professional services with a dedicated team that truly understands digital growth strategies.",
    readMore: true,
    color: "#60a5fa",
  },
  {
    ...
    date: "7 months ago",
    rating: 5,
    text: "Highly Recommended!! One of the Best Digital Marketing Agency that you can trust. Much appreciated for the great support and outstanding results they delivered for our business.",
    readMore: false,
    color: "#34d399",
  },
  {
    ...
    date: "8 months ago",
    rating: 5,
    text: "We hired MakTal for doing SEO for our business. Prompt communication and result oriented marketing plan. Their expertise in search optimization has significantly improved our online visibility.",
    readMore: true,
    color: "#f472b6",
  },
  {
    ...
    date: "9 months ago",
    rating: 5,
    text: "Thank you for doing our ecommerce website. Appreciating the skills. 😊",
    readMore: false,
    color: "#a78bfa",
  },
  {
    ...
    date: "10 months ago",
    rating: 5,
    text: "Outstanding web development services. The team at MakTal Technologies delivered a stunning website that exceeded our expectations. Very professional and timely delivery.",
    readMore: false,
    color: "#fb923c",
  },
  {
    ...
    date: "6 months ago",
    rating: 5,
    text: "MakTal transformed our online presence completely. Their social media marketing strategies brought us real customers and measurable growth. Highly recommended for any business!",
    readMore: true,
    color: "#e879f9",
  },
];
...
function GoogleWordmark() {
  return (
    <span className="inline-flex items-baseline text-[38px] sm:text-[40px] font-medium tracking-tight select-none" style={{ fontFamily: "'Product Sans', 'Google Sans', Arial, sans-serif" }}>
...
function CheckBadge() {
  return (
    <svg className="w-4 h-4 text-blue-500 inline-block ml-1" viewBox="0 0 24 24" fill="currentColor">
    ...
    <section className="w-full bg-[#0a0a0b] overflow-hidden">
      ...
      <div className="py-16 sm:py-15 lg:py-18.75">
        <div className="max-w-[1540px] mx-auto px-5 sm:px-8 md:px-12">
          ...
          <div className="hidden sm:flex items-stretch gap-4 lg:gap-4">
            ...
            <div className="shrink-0 w-45 lg:w-52.5 flex flex-col items-center justify-center text-center gap-3 py-4">
              ...
              <p className="text-[#f6f6f4] text-[13px] lg:text-[15px]">
                Based on <span className="font-bold">310</span> reviews
              </p>
              <GoogleWordmark />
            </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[#f6f6f4] text-[15px] font-bold truncate">
                        {review.name}
                      </p>
                  ...
                  {/* Read More */}
                  {review.readMore && (
                    <button className="mt-2 text-[#888] hover:text-[#ccc] text-[13px] text-left transition-colors duration-200">
                      Read more
                    </button>
                  )}
                </div>
          ...
          <p className="hidden sm:block text-right text-[#888] text-[14px] mt-4 lg:mt-5 pr-1">
            Showing our latest reviews
          </p>
          ...
          <div className="sm:hidden flex flex-col items-center">
            ...
            <div className="flex flex-col items-center gap-2 mb-8">
              <p className="text-[#f6f6f4] font-bold text-[20px] tracking-wide">
                EXCELLENT
              </p>
            ...
            <div
              ref={scrollRef}
              className="w-full flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 scrollbar-hide scroll-smooth px-[4vw]"
              onMouseEnter={() => setIsPaused(true)}
              onMouseLeave={() => setIsPaused(false)}
            >
              {reviews.map((review, index) => (
                ...
                {reviews.map((_, i) => (
                  <button
                    ...
                    className={`w-2 h-2 rounded-full transition-all duration-200 ${
                      i === activeIndex ? "bg-[#FFC107] w-4" : "bg-[#444]"
                    }`}
            ...
            <p className="text-[#888] text-[14px] mt-4">
              Showing our latest reviews
            </p>
          </div>
        </div>
