      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <ScrollReveal delay={260}>
          <div className="mt-12 text-center">
            <a href="#about" className="inline-flex items-center justify-center px-7 py-2.5 rounded-full border border-white/10 bg-transparent text-white/50 text-sm font-medium tracking-wide transition-all duration-300 hover:border-[#00D4FF]/40 hover:text-[#00D4FF] hover:bg-[#00D4FF]/5">
              Learn More
            </a>
          </div>
        </ScrollReveal>
